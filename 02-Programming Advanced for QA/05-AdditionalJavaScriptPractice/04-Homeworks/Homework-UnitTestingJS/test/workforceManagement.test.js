import { workforceManagement } from '../07-WorkforceManagement/workforceManagement.js'
...
describe('Test_workforceManagement', () => {
    ...
    describe('dismissEmployee', () => { //workforce - [string], employeeIndex - int index
        it('should throw error invalid input', () => {
            ...
            expect(() => workforceManagement.dismissEmployee(['Ivan', 'Stoyan'], 3.14)).to.throw('Invalid input');
            expect(() => workforceManagement.dismissEmployee(['Ivan', 'Stoyan'], 3)).to.throw('Invalid input');
            expect(() => workforceManagement.dismissEmployee(['Ivan', 'Stoyan'], -1)).to.throw('Invalid input');
        ...
        it('should return correct message', () => {
            expect(workforceManagement.dismissEmployee(['Ivan', 'Stoyan'], 1)).to.equal('Ivan');
            expect(workforceManagement.dismissEmployee(['Ivan', 'Stoyan', 'Kaloyan'], 1)).to.equal('Ivan, Kaloyan');
        });
    });
});