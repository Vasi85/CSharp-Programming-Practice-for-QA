        ...
        static void Main(string[] args)
        {
         List<int> numberList = Console.ReadLine()
            ...
            while (command != "End")
            {
                ...
                {
                    int count = int.Parse(commandNum[2]);
                    if (commandNum[1] == "left")
                    {
                    ...
                    else if (commandNum[1] == "right")
                    {
                        for (int i = 0; i < count; i++)
                        {
                            int lastNum = numberList[numberList.Count - 1];
                            numberList.RemoveAt(numberList.Count - 1);
                            numberList.Insert(0, lastNum);
                        }
                    }
                } 
